...
public class MainServlet extends HttpServlet {
	...
	private String toolTipCipher = "This is your encrypted vote, copy paste it to the token to generate a signature";
	private String toolTipSignature = "Please insert a signature generated by the token";
	...
	public String drawVotingInterfaceForElectionStep2(ElectionDto e, VoteDto vote) {
		...
		out += HtmlService.drawInputTextareaReadonly("text_cipher", "Encrypted Vote", "Cipher is supposed to be here", vote.getVoteEncrypted(), toolTipCipher);
		out += HtmlService.drawInputTextareaAlphanumeric("text_signature", "Signature", "Enter your signature here...", signature, vote.isVoteSignatureError(), vote.getVoteSignatureErrorMessage(), true, toolTipSignature);
		out += "</fieldset>";
		// buttons
		out += "<div class=\"row\">";
